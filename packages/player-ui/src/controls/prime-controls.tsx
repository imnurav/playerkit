...
export type PrimeControlsProps = {
    buffered: number;
    isMobile: boolean;
...
export function PrimeControls({
    ...
    return (
        <div
            className={`vhp-controls vhp-controls-prime ${isMobile ? "vhp-controls-mobile-prime" : "vhp-controls-desktop-prime"}`}
            data-vhp-controls
            onPointerEnter={onControlsInteraction}
        >
            <div className="vhp-progress vhp-progress-prime">
            ...
            <div className="vhp-control-row vhp-control-row-prime">
                <button
                    type="button"
                    className="vhp-icon-button vhp-icon-button-prime vhp-main-action"
                ...
                {!isMobile && (
                    <>
                        <button
                            type="button"
                            className="vhp-icon-button vhp-icon-button-prime"
                ...
                <span className="vhp-time vhp-time-prime">
                    {formatPlayerTime(state?.currentTime || 0)} /{" "}
                    {formatPlayerTime(state?.duration || 0)}
                </span>

                {/* {!isMobile && state && (
                    <span className="vhp-loaded vhp-loaded-prime" title="Loaded stream">
                        {Math.round(buffered)}% loaded
                    </span>
                )} */}

                <div className="vhp-sp  acer" />

                {!isMobile && (
                    <>
                        <label className="vhp-volume vhp-volume-prime" aria-label="Volume">
                            <button
                                type="button"
                                className="vhp-icon-button vhp-icon-button-prime"
                        ...
                        <div className="vhp-settings vhp-settings-prime" ref={settingsRef}>
                            <button
                                type="button"
                                className="vhp-icon-button vhp-icon-button-prime"
                            ...
                            {isSettingsOpen && (
                                <div className="vhp-settings-menu vhp-settings-menu-prime">
                                    <Settings
