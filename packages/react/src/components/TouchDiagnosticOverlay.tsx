...
export const TouchDiagnosticOverlay = memo(function TouchDiagnosticOverlay(
  ...
  return (
    <div className="pk-touch-diagnostic">
      {/* Left Seek Zone */}
      <div
        className="pk-touch-diagnostic__zone pk-touch-diagnostic__zone--left"
      ...
      {/* Right Seek Zone */}
      <div
        className="pk-touch-diagnostic__zone pk-touch-diagnostic__zone--right"
      ...
      <div
        className="pk-touch-diagnostic__zone pk-touch-diagnostic__zone--center"
        style={{
          left: `${cxStart * 100}%`,
