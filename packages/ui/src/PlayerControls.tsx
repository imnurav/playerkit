...
const ControlRow = memo(function ControlRow(props: ControlRowProps) {
  ...
  return (
    <div className="pk-control-row">
      {/* Play / Pause */}
      {showPlayBtn && (
        <button
          type="button"
          className="pk-icon-button pk-icon-button--primary"
      ...
      {progressBar && <div className="pk-progress-inline">{progressBar}</div>}
      ...
      {!progressBar && <div className="pk-spacer" />}
