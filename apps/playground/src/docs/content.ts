  ...
  sections: [
    {
      ...
      content: [
        ...
        },
        {
          type: "code",
          lang: "tsx",
          code: `import { Player } from "@nurav/player-react";\n\nfunction App() {\n  return (\n    <Player\n      src="https://example.com/stream.m3u8"\n      style={{ width: "100%", maxWidth: 900 }}\n    />\n  );\n}`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: "Starting with v0.0.3, player components **automatically load** the modular styles they require:",
        },
        {
          type: "list",
          items: [
      ...
      content: [
        {
          ...
          rows: [
            [
              ...
              "Check if your bundler supports CSS side-effects or manually import `@nurav/player-ui/styles/common.css` alongside `hls.css` or `youtube.css`",
            ],
            [
  ...
  sections: [
      ...
      content: [
        {
          type: "callout",
          variant: "note",
          text: "This package only provides UI components. For a complete working player, use `@nurav/player-react` instead. Use `@nurav/player-ui` only if you're building custom player controls.",
        },
        {
          type: "code",
          lang: "bash",
          code: `npm install @nurav/player-ui react react-dom`,
        },
        {
          type: "code",
          lang: "tsx",
          code: `import { PlayerControls, formatPlayerTime } from "@nurav/player-ui";\nimport "@nurav/player-ui/styles/common.css"; // Don't forget!\n\nfunction MyControls({ state, player }) {\n  return (\n    <PlayerControls\n      state={state}\n      player={player}\n      progress={50}\n      buffered={70}\n      seekRelative={(percent) => player.seek(percent * state.duration)}\n      formatTime={formatPlayerTime}\n    />\n  );\n}`,
        },
      ],
    },
    {
      ...
      content: [
        ...
        { type: "heading", level: 3, text: "CSS File → Component Mapping" },
        {
          ...
          rows: [
            ...
            [
              "`youtube.css`",
              "`vp-youtube-clip` (YouTube iframe scaling), `vp-youtube-poster` (custom poster overlay)",
            ],
            [
              "`hls.css`",
              "`vp-player__video` sizing overrides for native `<video>` element",
            ],
          ],
        },
      ],
    ...
    },
    {
      ...
      content: [
        ...
        { type: "heading", level: 3, text: "Available CSS Variables" },
        {
          type: "callout",
          variant: "note",
          text: "All CSS variables use the `--vp-` prefix and are scoped to the `.vp-player` root element — they won't leak into the rest of your application.",
        },
        {
          type: "table",
          headers: ["Variable", "Default", "What It Changes"],
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: "All classes follow BEM naming with the `vp-` prefix:",
        },
        {
          type: "table",
          ...
          rows: [
            ...
            ["`vp-live-badge--active`", "Live badge active state"],
