    ...
    <aside className={`pg-sidebar ${isSidebarOpen ? "is-open" : "is-closed"}`}>
      ...
      <nav className="pg-nav">
        ...
        <section className="pg-section">
          ...
          <div className={`pg-section-content ${expandedSections.simulator ? "is-expanded" : ""}`}>
            <div className="pg-section-inner">
              <div className="pg-sidebar-viewports-grid">
                {VIEWPORTS.map((v) => (
                  ...
                  >
                    <span className="pg-sidebar-viewport-icon">{viewportIcons[v.id]}</span>
                    <div className="pg-sidebar-viewport-info">
                      <span className="pg-sidebar-viewport-label">{v.label}</span>
                      {v.w && <span className="pg-sidebar-viewport-resolution">{v.w} × {v.h}px</span>}
                    </div>
                  </button>
                ))}
              </div>
              ...
              {viewport.device && (
                ...
                >
                  <IconRotate />
                  <span>Rotate Device ({landscape ? "Landscape" : "Portrait"})</span>
                </button>
              )}
            </div>
          </div>
        ...
        <section className="pg-section">
          ...
          <div className={`pg-section-content ${expandedSections.library ? "is-expanded" : ""}`}>
            <div className="pg-section-inner">
        ...
        <section className="pg-section">
          ...
          <div className={`pg-section-content ${expandedSections.theme ? "is-expanded" : ""}`}>
            <div className="pg-section-inner">
              <div className="pg-theme-grid">
                ...
                <div className="pg-custom-color-row">
                  <div className="pg-color-input-wrapper">
                    <input
                      type="color"
                      value={accentColor.startsWith("#") && accentColor.length === 7 ? accentColor : "#2e3192"}
                      onChange={(e) => {
        ...
        <section className="pg-section">
          ...
          <div className={`pg-section-content ${expandedSections.ui ? "is-expanded" : ""}`}>
            <div className="pg-section-inner">
              <div className="pg-custom-list">
                <label className="pg-toggle">
                  <input
                    ...
                    onChange={(e) => updateCustomization("showPlayButton", e.target.checked)}
                  />
                ...
                <label className="pg-toggle">
                  <input
                    ...
                    onChange={(e) => updateCustomization("showSettings", e.target.checked)}
                  />
                ...
                <label className="pg-toggle">
                  <input
                    ...
                    onChange={(e) => updateCustomization("showFullscreen", e.target.checked)}
                  />
                ...
                <label className="pg-toggle">
                  <input
                    ...
                    onChange={(e) => updateCustomization("showCenterOverlay", e.target.checked)}
                  />
                ...
                <label className="pg-toggle">
                  <input
                    ...
                    onChange={(e) => updateCustomization("showObjectFitButton", e.target.checked)}
                  />
                ...
                <div className="pg-select-group">
                  ...
                  <select
                    ...
                    onChange={(e) => updateCustomization("volumeControl", e.target.value as "horizontal" | "vertical" | "hidden")}
                    className="pg-select"
                  >
                ...
                <div className="pg-slider-group">
                  <div className="pg-slider-header">
                    ...
                    <span className="pg-slider-value">{customization.centerOverlayGap}px</span>
                  </div>
                  <input
                    type="range"
                    min={16}
                    ...
                    onChange={(e) => updateCustomization("centerOverlayGap", Number(e.target.value))}
                    className="pg-range"
                  />
                </div>
                ...
                <div className="pg-select-group">
                  ...
                  <select
                    ...
                    onChange={(e) => updateCustomization("objectFit", e.target.value as "contain" | "cover" | "fill")}
                    className="pg-select"
                  >
        ...
        <section className="pg-section pg-actions-section">
          ...
          <div className={`pg-section-content ${expandedSections.integration ? "is-expanded" : ""}`}>
            <div className="pg-section-inner">
              <div className="pg-action-buttons">
                <button type="button" onClick={copyReactCode} className="pg-outline-btn">
                  <IconCode />
                  <span>{copiedCode ? "Copied Props!" : "Copy React Code"}</span>
                </button>
                <button type="button" onClick={copyShareLink} className="pg-outline-btn">
                  <IconShare />
